        ...
        <div className="row justify-content-center">
          <div className="col-10 col-md-10 col-lg-8 col-xl-7">
            ...
            <p className="lead" style={biggerLead}>
              ...
              <a href="https://reactjs.org/" target="_blank" rel="noopener noreferrer">React</a> with{" "}
              <a href="https://firebase.google.com" target="_blank" rel="noopener noreferrer">Firebase</a>.
            </p>

            {user == null && (
              <span>
                <Link to="/personal-projects/meeting-log-spa/register" className="btn btn-outline-primary mr-2">
                  Register
                </Link>
                <Link to="/personal-projects/meeting-log-spa/login" className="btn btn-outline-primary mr-2">
                  Log In
                </Link>
              </span>
            )}
            ...
            {user && (
              <Link to="/personal-projects/meeting-log-spa/meetings" className="btn btn-primary">
                Meetings
              </Link>
            )}
          </div>{" "}
